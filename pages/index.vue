    ...
    <Row>
      <Column css-class="col-md-9">
        ...
        <div class="nuxt-content">
          <p>You can email me at <a href="mailto:matt@matteason.co.uk">matt@matteason.co.uk</a>.</p>
          ...
          <ul>
            ...
            <li>
              <a href="https://mastodon.online/@MattEason">Mastodon: @MattEason@mastodon.online</a>
            </li>
          </ul>
          <p>
